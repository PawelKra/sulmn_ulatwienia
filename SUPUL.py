...
class UPUL:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&sUPUL')

        self.toolbar = self.iface.addToolBar('sUPUL')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('UPUL', message)
    ...
    def initGui(self):
        ...
        # icon_path = ':/plugins/SUPUL/icon.png'
        # self.add_action(
        #     icon_path,
        ...
        self.menu.setObjectName('sUPUL')
        self.menu.setTitle('sUPUL')
        ...
        ico_tabela_wsk_e = QIcon(os.path.join(self.plugin_dir, 'ico',
                                              'tabelaw_e.png'))
        ico_tabela_r = QIcon(os.path.join(
            self.plugin_dir, 'ico', 'tabela_r.png'))
        ico_tabela_wsk_r = QIcon(os.path.join(self.plugin_dir, 'ico',
                                              'tabelaw_r.png'))
        ico_pow_graf = QIcon(os.path.join(self.plugin_dir, 'ico',
                                          'pow_graf.png'))
        ico_ust_map = QIcon(os.path.join(self.plugin_dir, 'ico',
                                         'pokazLay.png'))
        # --------------------
        ...
        self.menu.addAction(self.a_ewid)
        ...
        self.a_pok_wezelki = QAction(
            ico_ust_map, 'Pokaż węzełki',
            self.iface.mainWindow())
        self.a_ust_mape.triggered.connect(self.pokaz_wezelki)
        ...
        self.toolbar.addAction(self.a_rej)
        self.toolbar.addAction(self.a_klik_rej)
        self.toolbar.addSeparator()
        self.toolbar.addAction(self.a_pow_graf)
        self.toolbar.addAction(self.a_ust_mape)
        ...
        self.akcje_toolbara.append(self.a_rej)
        self.akcje_toolbara.append(self.a_klik_rej)
